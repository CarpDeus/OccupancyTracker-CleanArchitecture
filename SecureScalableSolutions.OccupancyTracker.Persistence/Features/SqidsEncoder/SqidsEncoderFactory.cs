...
namespace SecureScalableSolutions.OccupancyTracker.Persistence.Features.SqidsEncoder
{
    /// <summary>
    ...
    public class SqidsEncoderFactory : ISqidsEncoderFactory
    {
        ...
        public SqidsEncoderFactory(IConfiguration configuration)
        {
        ...
        private string GetSqidsAlphabet(string alphabetName)
        {
            ...
            var sqidAlphabets =  _configuration.GetSection("Sqids").Get<List<SqidAlphabet>>();
        ...
        /// <inheritdoc/>
        public ParsedSqids DecodeSqids(string? organizationSqid = null, string? locationSqid = null, string? entranceSqid = null, string? entranceCounterSqid = null)
        {
            var encoder = CreateEncoder("Default", 6);
            var parsedSqids = new ParsedSqids(encoder);
